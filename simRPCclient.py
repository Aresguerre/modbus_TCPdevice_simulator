...
class SimulatorRpcClient(object):
    ...
    def __init__(self, host="127.0.0.1", port=2711, timeout=2):
        """Constructor"""
        self.host = host
        self.port = port
    ...
    def _rpc_call(self, query):
        ...
        sock.close()
        return self._response_to_values(response.decode().strip("\r\n"), query.split(" ")[0])
...
if __name__ == "__main__":
    ...
    print(modbus_simu.set_values(1, 'regs_201', 30201, [5]))
